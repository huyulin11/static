...
import { data } from "./test.render.list.data.js?f=crmv000002";
import { render } from "./test.render.list.work.js?f=crmv000002";
import "/s/buss/crm/test/test.list.event.js?f=crmv000002";
...
gf.addChooseFlag({ container: "#chooseflags", id: 'showType1', name: '仅看良好', click: dataUdf });
