...
function MGlass(imageId, largeImageSrc, configObject){
    ...
    this.onMouseMove = function(e){
        ...
        if (imagePosition.x <= (e.clientX + pageOffset.x) &&
           ...
           mglassViewer.style.left = (x-700) + "px";
            mglassViewer.style.top = (y-345) + "px";
    ...
    wrapperElement.style.width = this.smallImage.style.posWidth + "px";
    wrapperElement.style.height = this.smallImage.style.posHeight + "px";
    ...
    pictureBoxElement.style.width = this.smallImage.style.posWidth + "px";
    pictureBoxElement.style.height = this.smallImage.style.posHeight + "px";
