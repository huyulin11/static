...
var SearchMgr = function(columnArray) { // argument:
	// formMgr.columnsDetail.queryColArray
	this.columns = new Array();
	/*
	 * item in Columns: name : String lable : String column : Column
	 * inputElement : InputElement : <input:text> <select> <div> searchCondition :
	 * Conditon
	 */
