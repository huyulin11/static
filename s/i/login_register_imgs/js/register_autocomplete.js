...
this.id = opt.id || 'suggest-container'; 
...
this.attr(this.container, 'id', this.id);
...
+ (pos[0]+document.documentElement.scrollLeft) + 'px;top:' 
+ (pos[1]+input.offsetHeight+document.documentElement.scrollTop) + 'px;width:' 
