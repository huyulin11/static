...
(function (factory) {
  ...
  //本的FileReader API是​​不实际使用，但可以作为特征检测，
    //为如Safari支持XHR文件上传通过参数formdata的API，
    //但不是非多部分的XHR文件上传：
    ...
    $.widget('blueimp.fileupload', {
        options: {
          ...
          //要上传较小的块大型文件，设置以下选项
                  //一个优选的最大块大小。如果设置为0，null或undefined，
                  //或浏览器不支持所需的Blob的API，文件将
                  //上传作为一个整体。
        ...
        // Maps jqXHR callbacks to the equivalent地图jqXHR回调的等价
        //给定无极对象的方法：
